...
import {
  ...
  InterOUMonthlyPieceRateWorkEdit1,
  InterOUMonthlyPieceRateWorkEdit2,
...
test.describe.serial("Inter-OU Monthly Piece Rate Work Tests", async () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await InterOUMonthlyPieceRateWorkEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await InterOUMonthlyPieceRateWorkEdit2(
      page,
      sideMenu,
      paths,
      columns,
