...
import {
  ...
  ContractCropDespatchRateEdit1,
  ContractCropDespatchRateEdit2,
...
test.describe.serial(`${formName} Tests`, async () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await ContractCropDespatchRateEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await ContractCropDespatchRateEdit2(
      page,
      sideMenu,
      paths,
      columns,
