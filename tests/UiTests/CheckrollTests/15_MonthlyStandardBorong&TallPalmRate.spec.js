...
import {
  ...
  MonthlyStandardBorongAndTallPalmRateEdit1,
  MonthlyStandardBorongAndTallPalmRateEdit2,
...
test.describe.serial(`${formName} Tests`, () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } =
      await MonthlyStandardBorongAndTallPalmRateEdit1(
        page,
        sideMenu,
        paths,
        columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } =
      await MonthlyStandardBorongAndTallPalmRateEdit2(
        page,
        sideMenu,
        paths,
        columns,
