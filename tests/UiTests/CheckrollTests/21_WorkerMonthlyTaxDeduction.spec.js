...
import {
  ...
  WorkerMonthlyTaxDeductionEdit1,
  WorkerMonthlyTaxDeductionEdit2,
...
test.describe.serial(`${formName} Tests`, () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await WorkerMonthlyTaxDeductionEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await WorkerMonthlyTaxDeductionEdit2(
      page,
      sideMenu,
      paths,
      columns,
