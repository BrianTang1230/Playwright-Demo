...
import {
  ...
  WorkerAdvancePaymentEdit1,
  WorkerAdvancePaymentEdit2,
...
test.describe.serial(`${formName} Tests`, async () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await WorkerAdvancePaymentEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await WorkerAdvancePaymentEdit2(
      page,
      sideMenu,
      paths,
      columns,
