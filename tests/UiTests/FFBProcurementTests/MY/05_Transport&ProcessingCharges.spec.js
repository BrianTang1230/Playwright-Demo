...
import {
  ...
  TransportProcessingChargesEdit1,
  TransportProcessingChargesEdit2,
...
test.describe.serial(`${formName} Tests`, () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await TransportProcessingChargesEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await TransportProcessingChargesEdit2(
      page,
      sideMenu,
      paths,
      columns,
