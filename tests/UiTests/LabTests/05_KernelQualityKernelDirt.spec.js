...
const formName = "Kernel Quality (Kernel Dirt)";
...
test.describe.serial("Kernel Quality (Kernel Dirt) Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Kernel Quality (Kernel Dirt)", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Kernel Quality (Kernel Dirt)", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Kernel Quality (Kernel Dirt)", async ({ page, db }) => {
    ...
    if (dbValues.length > 0)
      throw new Error("Deleting Kernel Quality (Kernel Dirt) failed");
  });
