...
const formName = "Kernel Quality (FFA)";
...
test.describe.serial("Kernel Quality (FFA) Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Kernel Quality (FFA)", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Kernel Quality (FFA)", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Kernel Quality (FFA)", async ({ page, db }) => {
    ...
    if (dbValues.length > 0)
      throw new Error("Deleting Kernel Quality (FFA) failed");
  });
