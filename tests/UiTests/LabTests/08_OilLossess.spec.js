...
test.describe.serial("Oil Lossess Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Oil Lossess", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Oil Lossess", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Oil Lossess", async ({ page, db }) => {
    ...
    if (dbValues.length > 0) throw new Error("Deleting Oil Lossess failed");
  });
