...
const formName = "Sludge Waste Losses";
...
test.describe.serial("Sludge Waste Losses Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Sludge Waste Losses", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Sludge Waste Losses", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Sludge Waste Losses", async ({ page, db }) => {
    ...
    if (dbValues.length > 0)
      throw new Error("Deleting Sludge Waste Losses failed");
  });
