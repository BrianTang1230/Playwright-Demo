...
test.describe.serial("Effluent Test Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Effluent Test", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Effluent Test", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Effluent Test", async ({ page, db }) => {
    ...
    if (dbValues.length > 0) throw new Error("Deleting Effluent Test failed");
  });
