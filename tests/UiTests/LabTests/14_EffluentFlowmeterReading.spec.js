...
const formName = "Effluent Flowmeter Reading";
...
test.describe.serial("Effluent Flowmeter Reading Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Effluent Flowmeter Reading", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Effluent Flowmeter Reading", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Effluent Flowmeter Reading", async ({ page, db }) => {
    ...
    if (dbValues.length > 0)
      throw new Error("Deleting Effluent Flowmeter Reading failed");
  });
