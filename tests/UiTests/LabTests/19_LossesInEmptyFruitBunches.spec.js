...
const formName = "Losses in Empty Fruit Bunches";
...
test.describe.serial("Losses in Empty Fruit Bunches Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Losses in Empty Fruit Bunches", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Losses in Empty Fruit Bunches", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Losses in Empty Fruit Bunches", async ({ page, db }) => {
    ...
    if (dbValues.length > 0)
      throw new Error("Deleting Losses in Empty Fruit Bunches failed");
  });
