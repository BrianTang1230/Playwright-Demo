...
const formName = "Spin Test";
const keyName = formName.split(" ").join("");
const paths = InputPath[keyName + "Path"].split(",");
const columns = InputPath[keyName + "Column"].split(",");
const gridPaths = GridPath[module + "Grid"].split(",");
const cellsIndex = [[1], [0, 1, 2, 3, 4, 5, 6, 7]];

test.describe.serial("Spin Test Tests", async () => {
  // ---------------- Before All ----------------
  ...
  // ---------------- Create Test ----------------
  test("Create New Spin Test", async ({ page, db }) => {
  ...
  // ---------------- Edit Test ----------------
  test("Edit Spin Test", async ({ page, db }) => {
  ...
  // ---------------- Delete Test ----------------
  test("Delete Spin Test", async ({ page, db }) => {
    ...
    if (dbValues.length > 0) throw new Error("Deleting Spin Test failed");
  });
