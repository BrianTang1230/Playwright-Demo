...
import {
  CheckrollDeductionCodeSetupCreate,
  CheckrollDeductionCodeSetupEdit1,
  CheckrollDeductionCodeSetupEdit2,
  CheckrollDeductionCodeSetupDelete,
} from "@UiFolder/pages/MasterFile/03_Checkroll/09_CheckrollDeductionCodeSetupPage";
...
const formName = "Checkroll Deduction Code Setup";
...
test.describe.serial(`${formName} Tests`, () => {
  ...
  test(`Create ${formName}`, async ({ page, db }) => {
    ...
    const { uiVals, gridVals } = await CheckrollDeductionCodeSetupCreate(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await CheckrollDeductionCodeSetupEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals, gridVals } = await CheckrollDeductionCodeSetupEdit2(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Delete ${formName}`, async ({ page, db }) => {
    await CheckrollDeductionCodeSetupDelete(page, sideMenu, editValues);
