...
import {
  ...
  PreNurseryTransferSoldLossEdit1,
  PreNurseryTransferSoldLossEdit2,
...
test.describe.serial(`${formName} Tests`, () => {
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals } = await PreNurseryTransferSoldLossEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals } = await PreNurseryTransferSoldLossEdit2(
      page,
      sideMenu,
      paths,
      columns,
