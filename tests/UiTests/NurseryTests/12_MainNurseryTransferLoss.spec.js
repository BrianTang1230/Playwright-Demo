...
import {
  ...
  MainNurseryTransferLossEdit1,
  MainNurseryTransferLossEdit2,
...
test.describe.serial(`${formName} Tests`, () => {
  ...
  test(`Create ${formName}`, async ({ page, db }) => {
    ...
    const { uiVals } = await MainNurseryTransferLossCreate(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} Without Saving`, async ({ page, db }) => {
    const { uiVals } = await MainNurseryTransferLossEdit1(
      page,
      sideMenu,
      paths,
      columns,
  ...
  test(`Edit ${formName} With Saving`, async ({ page, db }) => {
    const { uiVals } = await MainNurseryTransferLossEdit2(
      page,
      sideMenu,
      paths,
      columns,
