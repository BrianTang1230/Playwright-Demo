...
export async function ContractCropDespatchRateCreate(
  page,
  sideMenu,
  paths,
  columns,
...
export async function ContractCropDespatchRateEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function ContractCropDespatchRateEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function ContractCropDespatchRateDelete(
  page,
  sideMenu,
  values,
  ou,
