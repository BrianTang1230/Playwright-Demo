...
export async function MonthlyCCHandLFCCreate(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MonthlyCCHandLFCEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MonthlyCCHandLFCEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MonthlyCCHandLFCDelete(
  page,
  sideMenu,
  values,
  ou,
