...
export async function InterOUCropHarvestingAndCollectionCreate(
  page,
  sideMenu,
  paths,
  columns,
...
export async function InterOUCropHarvestingAndCollectionEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function InterOUCropHarvestingAndCollectionEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function InterOUCropHarvestingAndCollectionDelete(
  page,
  sideMenu,
  values,
  ou,
