...
export async function WorkerAdhocReimbursementEdit1(
  page,
  sideMenu,
  paths,
  columns,
  ...
  await runStep("Delete and add new grid item", async () => {
    await page.locator("#IsAdHocReimburseEmpySelectGrid").check();
...
export async function WorkerAdhocReimbursementEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function WorkerAdhocReimbursementDelete(
  page,
  sideMenu,
  values,
  ou,
