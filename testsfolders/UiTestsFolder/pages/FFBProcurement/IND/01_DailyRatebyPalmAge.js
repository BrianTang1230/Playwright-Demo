...
export async function DailyRatebyPalmAgeEdit1(
  page,
  sideMenu,
  paths,
  columns,
  ...
  const month = await convertTextMonth(values[0]);
  const year = values[0].split("/")[2];
...
export async function DailyRatebyPalmAgeEdit2(
  page,
  sideMenu,
  paths,
  columns,
