...
export async function FFBProcurementPaymentCreate(
  page,
  sideMenu,
  paths,
  columns,
...
export async function FFBProcurementPaymentEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function FFBProcurementPaymentEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function FFBProcurementPaymentDelete(page, sideMenu, values, ou) {
  await runStep("Filter transaction", async () => {
    await FilterTransactionBy2And1Criterias(
      page,
      values[0],
