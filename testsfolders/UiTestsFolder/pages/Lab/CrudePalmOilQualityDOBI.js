...
export async function CrudePalmOilQualityDOBICreate(
  page,
  sideMenu,
  paths,
  columns,
...
export async function CrudePalmOilQualityDOBIEdit(
  page,
  sideMenu,
  paths,
  columns,
...
export async function CrudePalmOilQualityDOBIDelete(
  page,
  sideMenu,
  values,
  ou,
