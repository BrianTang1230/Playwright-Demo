...
export async function CrudePalmOilQualityMoistureCreate(
  page,
  sideMenu,
  paths,
  columns,
...
export async function CrudePalmOilQualityMoistureEdit(
  page,
  sideMenu,
  paths,
  columns,
...
export async function CrudePalmOilQualityMoistureDelete(
  page,
  sideMenu,
  values,
  ou,
