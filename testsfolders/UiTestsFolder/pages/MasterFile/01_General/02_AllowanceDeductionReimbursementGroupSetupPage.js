...
// Create Function
export async function PayGroupCodeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function PayGroupCodeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function PayGroupCodeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function PayGroupCodeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
