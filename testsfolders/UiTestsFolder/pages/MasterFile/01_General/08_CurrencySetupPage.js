...
// Create Function
export async function CurrencySetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function CurrencySetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function CurrencySetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function CurrencySetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
