...
// Create Function
export async function LocationSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function LocationSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function LocationSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function LocationSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
