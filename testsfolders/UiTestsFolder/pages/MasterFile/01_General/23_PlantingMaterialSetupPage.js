...
// Create Function
export async function PlantingMaterialSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function PlantingMaterialSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function PlantingMaterialSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function PlantingMaterialSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
