...
// Create Function
export async function PositionTypeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function PositionTypeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function PositionTypeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function PositionTypeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
