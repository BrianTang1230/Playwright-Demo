...
// Create Function
export async function RaceSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function RaceSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function RaceSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function RaceSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
