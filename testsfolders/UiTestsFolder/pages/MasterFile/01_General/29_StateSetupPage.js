...
// Create Function
export async function StateSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function StateSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function StateSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function StateSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
