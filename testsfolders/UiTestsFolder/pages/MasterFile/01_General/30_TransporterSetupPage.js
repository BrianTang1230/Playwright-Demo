...
// Create Function
export async function TransporterSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function TransporterSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function TransporterSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function TransporterSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
