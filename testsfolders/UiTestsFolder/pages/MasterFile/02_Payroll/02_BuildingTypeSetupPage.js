...
// Create Function
export async function BuildingTypeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function BuildingTypeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function BuildingTypeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function BuildingTypeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
