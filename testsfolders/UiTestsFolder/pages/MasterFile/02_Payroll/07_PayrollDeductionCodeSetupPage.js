...
// Create Function
export async function PayrollDeductionCodeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function PayrollDeductionCodeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function - 2
export async function PayrollDeductionCodeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function PayrollDeductionCodeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
