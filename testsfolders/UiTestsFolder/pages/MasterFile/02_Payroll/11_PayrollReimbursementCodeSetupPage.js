...
// Create Function
export async function PayrollReimbursementCodeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function PayrollReimbursementCodeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function - 2
export async function PayrollReimbursementCodeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function PayrollReimbursementCodeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
