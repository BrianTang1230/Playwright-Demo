...
// Create Function
export async function CropPenaltySetupCreate(
  page,
  sideMenu,
  paths,
  columns,
  ...
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.viewModeOU.pinOU .k-dropdown .k-select",
...
// Edit Function
export async function CropPenaltySetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
  ...
  await runStep("Select OU", async () => {
    await SelectOU(
      ...
      "#comboBoxDisplayOU_listbox li span",
      ou[0],
    );
  });
...
export async function CropPenaltySetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function CropPenaltySetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
