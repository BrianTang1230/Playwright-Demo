...
// Create Function
export async function AgencySetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function AgencySetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function AgencySetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function AgencySetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
