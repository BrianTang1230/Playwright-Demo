...
// Create Function
export async function ForeignWorkerBatchSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function ForeignWorkerBatchSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function ForeignWorkerBatchSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function ForeignWorkerBatchSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
