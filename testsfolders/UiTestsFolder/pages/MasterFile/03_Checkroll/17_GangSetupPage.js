...
// Create Function
export async function GangSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function GangSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function GangSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function GangSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
