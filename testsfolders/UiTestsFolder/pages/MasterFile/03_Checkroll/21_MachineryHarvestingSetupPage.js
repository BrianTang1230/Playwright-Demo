...
// Create Function
export async function MachineryHarvestingSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function MachineryHarvestingSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MachineryHarvestingSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function MachineryHarvestingSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
