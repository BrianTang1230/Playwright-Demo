...
// Create Function
export async function MedicalLeaveProfileSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function MedicalLeaveProfileSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function - 2
export async function MedicalLeaveProfileSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function MedicalLeaveProfileSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
