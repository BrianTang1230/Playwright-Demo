...
// Create Function
export async function RecoveryTypeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function RecoveryTypeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function RecoveryTypeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function RecoveryTypeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
