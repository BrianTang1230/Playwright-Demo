...
// Create Function
export async function TallPalmImpedimentSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function TallPalmImpedimentSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function TallPalmImpedimentSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function TallPalmImpedimentSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
