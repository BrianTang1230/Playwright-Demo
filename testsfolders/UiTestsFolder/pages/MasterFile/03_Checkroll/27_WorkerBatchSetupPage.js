...
// Create Function
export async function WorkerBatchSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function WorkerBatchSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function WorkerBatchSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function WorkerBatchSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
