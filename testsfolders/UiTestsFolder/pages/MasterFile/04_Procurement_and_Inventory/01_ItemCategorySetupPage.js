...
// Create Function
export async function ItemCategorySetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function ItemCategorySetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function ItemCategorySetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function ItemCategorySetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
