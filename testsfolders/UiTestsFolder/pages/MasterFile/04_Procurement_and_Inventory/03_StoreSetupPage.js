...
// Create Function
export async function StoreSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function StoreSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function StoreSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function StoreSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
