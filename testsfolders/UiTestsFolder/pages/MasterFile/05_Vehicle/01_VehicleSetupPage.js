...
// Create Function
export async function VehicleSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function VehicleSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function VehicleSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function VehicleSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
