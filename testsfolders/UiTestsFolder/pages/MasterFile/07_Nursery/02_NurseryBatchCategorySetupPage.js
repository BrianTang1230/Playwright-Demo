...
// Create Function
export async function NurseryBatchCategorySetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function NurseryBatchCategorySetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function NurseryBatchCategorySetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function NurseryBatchCategorySetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
