...
// Create Function
export async function MillEquipmentSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function MillEquipmentSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MillEquipmentSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function MillEquipmentSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
