...
// Create Function
export async function StationSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function StationSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function - 2
export async function StationSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function StationSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
