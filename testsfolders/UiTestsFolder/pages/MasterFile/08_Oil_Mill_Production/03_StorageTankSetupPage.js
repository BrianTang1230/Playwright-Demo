...
// Create Function
export async function StorageTankSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function StorageTankSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function StorageTankSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function StorageTankSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
