...
// Create Function
export async function StockAdjustmentRemarkSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function StockAdjustmentRemarkSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function StockAdjustmentRemarkSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function StockAdjustmentRemarkSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
