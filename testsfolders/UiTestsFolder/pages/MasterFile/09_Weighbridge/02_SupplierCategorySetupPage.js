...
// Create Function
export async function SupplierCategorySetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function SupplierCategorySetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function SupplierCategorySetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function SupplierCategorySetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
