...
// Create Function
export async function ExternalBlockSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
  ...
  await runStep("Click yes after confirming to switch OU", async () => {
    const option = page.locator('#btnMsgBoxYes');
    await option.click();
  });
...
// Edit Function
export async function ExternalBlockSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function ExternalBlockSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function ExternalBlockSetupDelete(page, sideMenu, newValues, ou) {
  await runStep("Select OU", async () => {
    await SelectOU(
      page,
      "div#divComboOU.masterModeOU .k-dropdown .k-select",
