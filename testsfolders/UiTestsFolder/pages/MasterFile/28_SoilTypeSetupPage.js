...
// Create Function
export async function SoilTypeSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function SoilTypeSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function SoilTypeSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function SoilTypeSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
