...
// Create Function
export async function UOMSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function UOMSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function UOMSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function UOMSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
