...
// Create Function
export async function WeighingItemSetupCreate(
  page,
  sideMenu,
  paths,
  columns,
...
// Edit Function
export async function WeighingItemSetupEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function WeighingItemSetupEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
// Delete Function
export async function WeighingItemSetupDelete(page, sideMenu, newValues) {
  await runStep("Open transaction", async () => {
