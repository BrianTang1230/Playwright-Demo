...
export async function MainNurseryDoubletonSplittingEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MainNurseryDoubletonSplittingEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MainNurseryDoubletonSplittingDelete(
  page,
  sideMenu,
  values,
  ou,
