...
export async function MainNurseryTransferLossEdit1(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MainNurseryTransferLossEdit2(
  page,
  sideMenu,
  paths,
  columns,
...
export async function MainNurseryTransferLossDelete(
  page,
  sideMenu,
  values,
  ou,
