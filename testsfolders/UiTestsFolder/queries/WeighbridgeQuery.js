  ...
  switch (formName) {
    case "Daily Total Crop Receipt by Crop Supplier":
      sqlCommand = `
        ...
        SELECT 
          B.EstateCode + ' - ' + B.EstateDesc AS Estate,
        ...
        WHERE A.DailyTotCropRcvBySuppHdrKey IN (SELECT DailyTotCropRcvBySuppHdrKey FROM FilteredHdr)`;
      break;
  }
